<template>
  <div class="navbar" :class="{ change_color: scrollPosition > 200 }">
    <a class="left" href="https://www.instagram.com/mariusmomkus/">
      <img src="@/assets/Insta.png"  />
      <p>Marius Momkus</p>
    </a>
    <div class="center">
      <div class="logo">Marcus_Designs</div>
      <div class="navlink">
        ...
        <router-link class="nav-page" to="/Register">Register</router-link>
        <router-link class="nav-page" to="/SignIn">SignIn</router-link>
      </div>
    </div>
    <div class="right">
      <div class="search">
